...
export default function getInputSelectStyles(settings) {
  let styles = [
    ...
    '.altrp-field-label-container',
      ...
      ["flex-direction", "label_icon_position"],
    '}',
    '.altrp-field-label',
    ...
    "altrp-select-tree-btn.altrp-select-tree-btn",
      ...
      () => {
        const value = getResponsiveSetting(settings, "alignment");
        let styles = "";
        switch (value) {
          case "left":
              styles = "width: auto;margin-right: auto;";
            break
          case "center":
            styles = "width: auto;margin-right: auto;margin-left: auto;";
            break
          case "right":
      ...
      () => {
        const value = getResponsiveSetting(settings, "button_width");
